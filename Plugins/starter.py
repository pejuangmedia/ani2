...
class start():
    ...
    @bot.on(events.NewMessage(pattern=r"^/mulai$|^/mulai@Anime_Gallery_Robot"))
    ...
    @bot.on(events.NewMessage(pattern=r"^/helpk$|^/help@Anime_Gallery_Robot"))
    ...
    @bot.on(events.NewMessage(pattern="/sourcei"))
